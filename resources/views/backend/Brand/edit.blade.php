    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <form role="form" method="post" action="{{route('backend.brands.update',$brand->id)}}">
                  @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Thương hiệu</label>
                            <input name="name" type="text" class="form-control" id="" placeholder="Thương hiệu" value="{{ $brand->name }}">
