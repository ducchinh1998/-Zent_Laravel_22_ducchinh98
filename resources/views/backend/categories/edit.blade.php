...
@section ('content')
<div class="container">
<form action="{{ route('backend.categories.update', $category->id) }}" method="POST" role="form" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="_method" value="put">
        ...
        <div>
          <a href="{{ route('backend.categories.index') }}" class="btn btn-primary">Hủy</a>
