...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Tạo mới sản phẩm</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
                ...
                <form role="form" method="post" action="{{route('backend.products.store')}}" enctype="multipart/form-data">
                  @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group  col-6">
                                ...
                                <input name="origin_price" type="text" class="form-control" id="" placeholder="Giá gốc" >
                                @error('origin_price')
                                <span style="color:red;margin-bottom:8px;display:block;margin-left:8px;"> {{ $message }} </span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-6">
                                ...
                                <input name="sale_price" type="text" class="form-control" id="" placeholder="Giá bán" >
                                @error('sale_price')
                                <span style="color:red;margin-bottom:8px;display:block;margin-left:8px;"> {{ $message }} </span>
                                @enderror
                            </div>
                    ...
                    <div class="card-footer">
                        <a href="{{ route('backend.products.index') }}" type="reset" class="btn btn-default">Huỷ bỏ</a>
